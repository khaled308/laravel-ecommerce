...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
     ...
     <ul class="sidebar-menu" data-widget="tree">
        ...
        <li @class(["treeview", 'active' => $route == "brands"])>
           <a href="#">
           ...
           <ul class="treeview-menu">
              <li><a href="{{route('admin.brands.index')}}"><i class="ti-more"></i>All Brands</a></li>
           </ul>
        </li>
        <li @class(["treeview", 'active' => $route == "categories"])>
           <a href="#">
           ...
           <ul class="treeview-menu">
              <li><a href="{{route('admin.categories.index')}}"><i class="ti-more"></i>All Categories</a></li>
           </ul>
        </li>
        <li @class(["treeview", 'active' => $route == "products"])>
           <a href="#">
           ...
           <ul class="treeview-menu">
              <li><a href="{{route('admin.products.index')}}"><i class="ti-more"></i>Products</a></li>
              <li><a href="{{route('admin.products.create')}}"><i class="ti-more"></i>Add Product</a></li>
           </ul>
        </li>

        <li @class(["treeview", 'active' => $route == "website"])>
         <a href="#">
         <i data-feather="file"></i>
         <span>Website</span>
         <span class="pull-right-container">
         ...
         <ul class="treeview-menu">
            <li @class(["treeview", 'active' => $route == "website"])>
               ...
               <ul class="treeview-menu">
                  <li><a href="{{route('admin.website.slider.index')}}"><i class="ti-more"></i>Sliders</a></li>
               </ul>
               </li>
         </ul>
         </li>
